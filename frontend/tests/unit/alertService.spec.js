...
describe('alertService', () => {
  ...
  it('registers alert system and shows alerts', () => {
    ...
    expect(mockAlertSystem.addAlert).toHaveBeenCalledWith('Test message', 'success', 3000);
  ...
  it('uses default parameters when not provided', () => {
    ...
    expect(mockAlertSystem.addAlert).toHaveBeenCalledWith('Test message', 'info', 5000);
  });
});