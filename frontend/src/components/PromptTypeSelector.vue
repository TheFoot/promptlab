    ...
    <div class="type-grid">
      ...
      >
        ...
        <div class="type-content">
          ...
          <div
            v-if="showBestPractices && type.bestPractices && type.bestPractices.length"
...
const filteredTypes = computed(() => {
  ...
  if (props.purpose) {
    types = types.filter(type => {
      ...
      return !type.compatiblePurposes || type.compatiblePurposes.includes(props.purpose);
    });
  }
  ...
  return [
    {
      ...
      compatiblePurposes: ['information', 'generation', 'transformation', 'analysis', 'conversation']
    },
    {
      id: 'coding',
      name: 'Code Generation',
      description: 'Prompts optimized for generating, explaining, or debugging code',
      icon: 'fas fa-code',
      featured: true,
    ...
    },
    {
      ...
      description: 'Prompts for generating stories, poetry, and creative content',
    ...
    },
    {
      id: 'analytical',
      name: 'Data Analysis',
      description: 'Prompts for analyzing data, extracting insights, and summarizing findings',
    ...
    },
    {
      ...
      description: 'Prompts for creating step-by-step instructions and educational content',
    ...
    },
    {
      ...
      example: 'Design a customer service chatbot that can handle common support questions',
      bestPractices: [
...
watch(() => props.purpose, () => {
  ...
  if (props.purpose && props.modelValue) {
    const currentType = promptTypes.value.find(t => t.id === props.modelValue);
    if (currentType && currentType.compatiblePurposes && 
